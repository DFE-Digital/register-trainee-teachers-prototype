...
const routeRatios = {
  SCITT: {
    ...
    'Provider-led (postgraduate)': 0.30,
    'Provider-led (postgraduate salaried)': 0.30,
    'Provider-led (undergrad)': 0,
    'School direct (fee funded)': 0.34,
    'School direct (salaried)': 0.08,
    'Teaching apprenticeship (postgraduate)': 0.05,
  ...
  HEI: {
    ...
    'High potential initial teacher training (HPITT)': 0,
    'Opt-in (undergrad)': 0.02,
    'Provider-led (postgraduate)': 0.45,
    'Provider-led (postgraduate salaried)': 0.45,
