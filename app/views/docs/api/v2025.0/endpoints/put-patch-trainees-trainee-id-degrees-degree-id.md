...
<dl class="govuk-summary-list">
  <div class="govuk-summary-list__row govuk-summary-list__row--no-actions">
    ...
    <dd class="govuk-summary-list__value">
      <p class="govuk-body">
        <%= link_to "Degree", "/api-docs/v2025.0/objects/degree.html" %> object
      </p>
    </dd>
  </div>
</dl>
...
When updating a degree, a duplication validation is performed to ensure that duplicate degrees are not created.
