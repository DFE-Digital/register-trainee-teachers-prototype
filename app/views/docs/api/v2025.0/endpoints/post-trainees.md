...
<dl class="govuk-summary-list">
  <div class="govuk-summary-list__row govuk-summary-list__row--no-actions">
    ...
    <dd class="govuk-summary-list__value">
      <p class="govuk-body">
        <%= link_to "Trainee", "/v2025.0/objects/trainee.html" %> object with nested
        <%= link_to "Placement", "/v2025.0/objects/placement.html" %> and
        <%= link_to "Degree", "/v2025.0/objects/degree.html" %> objects
      </p>
    </dd>
  </div>
</dl>
